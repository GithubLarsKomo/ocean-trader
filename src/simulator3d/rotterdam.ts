...
export const ROTTERDAM_P5: P5HarbourScenario = {
  ...
  buoys: [
    { id: 'r1', x: -24, z: -8.5, radius: .55, side: 'port' },
    { id: 'g1', x: -24, z: 8.5, radius: .55, side: 'starboard' },
    { id: 'r2', x: -8, z: -8.5, radius: .55, side: 'port' },
    { id: 'g2', x: -8, z: 8.5, radius: .55, side: 'starboard' },
    { id: 'r3', x: 8, z: -8.5, radius: .55, side: 'port' },
    { id: 'g3', x: 8, z: 8.5, radius: .55, side: 'starboard' },
    { id: 'r4', x: 24, z: -8.5, radius: .55, side: 'port' },
    { id: 'g4', x: 24, z: 8.5, radius: .55, side: 'starboard' },
  ],
}
