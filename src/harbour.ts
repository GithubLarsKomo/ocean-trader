export interface Rect { x:number; y:number; width:number; height:number; w:number; h:number; }
...
export const HARBOUR={width:1200,height:720,berth:{x:930,y:180,width:170,height:54,w:170,h:54,heading:0},shallow:[{x:0,y:0,width:1200,height:48,w:1200,h:48},{x:0,y:0,width:70,height:720,w:70,h:720},{x:0,y:640,width:1200,height:80,w:1200,h:80},{x:1050,y:0,width:150,height:130,w:150,h:130}],quays:[{x:820,y:105,width:340,height:42,w:340,h:42},{x:820,y:247,width:340,height:42,w:340,h:42},{x:1120,y:105,width:40,height:184,w:40,h:184}],breakwaters:[{x:330,y:450,width:260,height:34,w:260,h:34},{x:330,y:450,width:34,height:170,w:34,h:170}]};
