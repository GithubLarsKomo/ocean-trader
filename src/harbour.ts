...
export const HARBOUR={width:1200,height:720,berth:{x:930,y:180,w:170,h:54,heading:0},shallow:[{x:0,y:0,w:1200,h:48},{x:0,y:0,w:70,h:720},{x:0,y:640,w:1200,h:80},{x:1050,y:0,w:150,h:130}],quays:[{x:820,y:105,w:340,h:42},{x:820,y:247,w:340,h:42},{x:1120,y:105,w:40,h:184}],breakwaters:[{x:330,y:450,w:260,h:34},{x:330,y:450,w:34,h:170}]};
...
export function isDocked(s:HarbourState){const b=HARBOUR.berth;const centerOk=s.x>b.x&&s.x<b.x+b.w&&s.y>b.y&&s.y<b.y+b.h;return centerOk&&Math.abs(s.speed)<.22&&Math.abs(normAngle(s.heading-b.heading))<.18;}
