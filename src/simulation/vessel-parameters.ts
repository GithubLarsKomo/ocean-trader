...
export const VESSEL_PARAMETERS: Record<SimulationVesselClass, VesselParameters> = {
  coaster: {
    ...
    propellerHandedness: 'right', propWalkStrength: .022, propWalkLeverArm: 7.3, propWalkAheadFactor: .13, propWalkSpeedDecay: .34,
  ...
  handysize: {
    ...
    propellerHandedness: 'right', propWalkStrength: .025, propWalkLeverArm: 7.8, propWalkAheadFactor: .12, propWalkSpeedDecay: .32,
  ...
  feeder: {
    ...
    propellerHandedness: 'right', propWalkStrength: .0215, propWalkLeverArm: 7.9, propWalkAheadFactor: .10, propWalkSpeedDecay: .30,
  ...
  panamax: {
    ...
    propellerHandedness: 'right', propWalkStrength: .0175, propWalkLeverArm: 8.0, propWalkAheadFactor: .09, propWalkSpeedDecay: .27,
